...
std::tuple<double, double, double, double, double> Biquad::getCoefs(void)
{
	return std::tuple<double, double, double, double, double>(this->b1, this->b2, this->a0, this->a1, this->a2);
}
